...
#number of classes
nClass = 10
addr_train = "/home/pavelkrolevets/Working/TF_facenet/data/CIFAR_TFrec/cifar10_train.tfrecord"
addr_val = "/home/pavelkrolevets/Working/TF_facenet/data/CIFAR_TFrec/cifar10_test.tfrecord"
...
def inference(x): #, keep_prob):
    ...
    with tf.variable_scope("fc1"):
        ...
        fc_1 = layer(pool_2_flat, [8 * 8 * 64, 384], [384], stdev=0.04, wd=0.004)
    ...
    with sess.as_default():
        ...
        for epoch in range(training_epochs):
            ...
            for i in range(total_batch_train):
                ...
                if not i % 10:
                    print('Epoch #: ', epoch, '  Batch #: ', i , 'train precision: ', train_precision,
                          ' Global step:', sess.run(global_step))
